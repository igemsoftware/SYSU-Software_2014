 ...
 */
graphiti.layout.locator.UnbindLocator = graphiti.layout.locator.Locator.extend({
    NAME : "graphiti.layout.locator.UnbindLocator",
    ...
    relocate:function(index, target)
    {
       ...
       target.setPosition(this.no * this.base - 15, boundingBox.h/2 - 10);
    }
});
