...
/**
 * @class graphiti.shape.icon.Apps

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Apps();
 ...
 */
graphiti.shape.icon.Apps = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Apps",
