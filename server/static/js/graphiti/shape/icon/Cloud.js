...
/**
 * @class graphiti.shape.icon.Cloud

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Cloud();
 ...
 */
graphiti.shape.icon.Cloud = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Cloud",
