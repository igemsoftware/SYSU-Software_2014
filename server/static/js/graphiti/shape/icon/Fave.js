...
/**
 * @class graphiti.shape.icon.Fave

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Fave();
 ...
 */
graphiti.shape.icon.Fave = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Fave",
