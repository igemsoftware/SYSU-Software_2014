...
/**
 * @class graphiti.shape.icon.Windows

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Windows();
 ...
 */
graphiti.shape.icon.Windows = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Windows",
