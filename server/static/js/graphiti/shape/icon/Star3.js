...
/**
 * @class graphiti.shape.icon.Star3

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Star3();
 ...
 */
graphiti.shape.icon.Star3 = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Star3",
