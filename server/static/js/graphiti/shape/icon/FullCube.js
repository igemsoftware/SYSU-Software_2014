...
/**
 * @class graphiti.shape.icon.FullCube

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.FullCube();
 ...
 */
graphiti.shape.icon.FullCube = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.FullCube",
