...
/**
 * @class graphiti.shape.icon.Star

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Star();
 ...
 */
graphiti.shape.icon.Star = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Star",
