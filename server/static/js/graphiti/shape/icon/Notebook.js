...
/**
 * @class graphiti.shape.icon.Notebook

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Notebook();
 ...
 */
graphiti.shape.icon.Notebook = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Notebook",
