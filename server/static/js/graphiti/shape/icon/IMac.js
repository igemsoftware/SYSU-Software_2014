...
/**
 * @class graphiti.shape.icon.IMac

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.IMac();
 ...
 */
graphiti.shape.icon.IMac = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.IMac",
