...
/**
 * @class graphiti.shape.icon.Chrome

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Chrome();
 ...
 */
graphiti.shape.icon.Chrome = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Chrome",
