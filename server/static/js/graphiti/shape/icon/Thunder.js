...
/**
 * @class graphiti.shape.icon.Thunder

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Thunder();
 ...
 */
graphiti.shape.icon.Thunder = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Thunder",
