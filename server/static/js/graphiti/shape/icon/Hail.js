...
/**
 * @class graphiti.shape.icon.Hail

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Hail();
 ...
 */
graphiti.shape.icon.Hail = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Hail",
