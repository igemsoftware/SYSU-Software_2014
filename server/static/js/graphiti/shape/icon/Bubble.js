...
/**
 * @class graphiti.shape.icon.Bubble

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Bubble();
 ...
 */
graphiti.shape.icon.Bubble = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Bubble",
