...
/**
 * @class graphiti.shape.icon.Paper

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Paper();
 ...
 */
graphiti.shape.icon.Paper = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Paper",
