...
/**
 * @class graphiti.shape.icon.InkScape

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.InkScape();
 ...
 */
graphiti.shape.icon.InkScape = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.InkScape",
