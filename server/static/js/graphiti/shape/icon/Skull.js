...
/**
 * @class graphiti.shape.icon.Skull

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Skull();
 ...
 */
graphiti.shape.icon.Skull = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Skull",
