...
/**
 * @class graphiti.shape.icon.Anonymous

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Anonymous();
 ...
 */
graphiti.shape.icon.Anonymous = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Anonymous",
