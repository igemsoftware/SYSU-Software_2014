...
/**
 * @class graphiti.shape.icon.Landscape1

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Landscape1();
 ...
 */
graphiti.shape.icon.Landscape1 = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Landscape1",
