...
/**
 * @class graphiti.shape.icon.Plus

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Plus();
 ...
 */
graphiti.shape.icon.Plus = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Plus",
