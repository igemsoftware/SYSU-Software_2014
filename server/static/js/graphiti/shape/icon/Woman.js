...
/**
 * @class graphiti.shape.icon.Woman

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Woman();
 ...
 */
graphiti.shape.icon.Woman = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Woman",
