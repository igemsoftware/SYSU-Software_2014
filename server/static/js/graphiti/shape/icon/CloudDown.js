...
/**
 * @class graphiti.shape.icon.CloudDown

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.CloudDown();
 ...
 */
graphiti.shape.icon.CloudDown = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.CloudDown",
