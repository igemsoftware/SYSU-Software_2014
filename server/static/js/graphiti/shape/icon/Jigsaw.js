...
/**
 * @class graphiti.shape.icon.Jigsaw

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Jigsaw();
 ...
 */
graphiti.shape.icon.Jigsaw = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Jigsaw",
