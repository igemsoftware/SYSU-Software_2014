...
/**
 * @class graphiti.shape.icon.Customer

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Customer();
 ...
 */
graphiti.shape.icon.Customer = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Customer",
