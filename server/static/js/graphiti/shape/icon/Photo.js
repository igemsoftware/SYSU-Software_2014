...
/**
 * @class graphiti.shape.icon.Photo

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Photo();
 ...
 */
graphiti.shape.icon.Photo = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Photo",
