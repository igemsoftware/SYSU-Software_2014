...
/**
 * @class graphiti.shape.icon.Hammer

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Hammer();
 ...
 */
graphiti.shape.icon.Hammer = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Hammer",
