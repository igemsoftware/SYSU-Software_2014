...
/**
 * @class graphiti.shape.icon.Printer

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Printer();
 ...
 */
graphiti.shape.icon.Printer = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Printer",
