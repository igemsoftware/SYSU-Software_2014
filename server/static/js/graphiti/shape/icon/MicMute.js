...
/**
 * @class graphiti.shape.icon.MicMute

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.MicMute();
 ...
 */
graphiti.shape.icon.MicMute = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.MicMute",
