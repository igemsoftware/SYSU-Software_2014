...
/**
 * @class graphiti.shape.icon.Locked

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Locked();
 ...
 */
graphiti.shape.icon.Locked = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Locked",
