graphiti.shape.icon.ProteinIcon = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.ProteinIcon",
    ...
    createSet : function() {
        ...
        return this.canvas.paper.image("../static/img/protein.png", 0, 0, 107, 94);
    }
});
