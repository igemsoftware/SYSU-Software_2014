...
/**
 * @class graphiti.shape.icon.GRaphael

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.GRaphael();
 ...
 */
graphiti.shape.icon.GRaphael = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.GRaphael",
