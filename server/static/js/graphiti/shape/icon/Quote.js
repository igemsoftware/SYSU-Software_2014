...
/**
 * @class graphiti.shape.icon.Quote

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Quote();
 ...
 */
graphiti.shape.icon.Quote = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Quote",
