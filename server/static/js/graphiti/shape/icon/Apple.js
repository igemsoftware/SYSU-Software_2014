...
/**
 * @class graphiti.shape.icon.Apple

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Apple();
 ...
 */
graphiti.shape.icon.Apple = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Apple",
