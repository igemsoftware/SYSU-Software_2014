...
/**
 * @class graphiti.shape.icon.Parent

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Parent();
 ...
 */
graphiti.shape.icon.Parent = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Parent",
