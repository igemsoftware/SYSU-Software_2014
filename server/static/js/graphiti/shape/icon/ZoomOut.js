...
/**
 * @class graphiti.shape.icon.ZoomOut

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.ZoomOut();
 ...
 */
graphiti.shape.icon.ZoomOut = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.ZoomOut",
