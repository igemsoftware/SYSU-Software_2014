...
/**
 * @class graphiti.shape.icon.Contract

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Contract();
 ...
 */
graphiti.shape.icon.Contract = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Contract",
