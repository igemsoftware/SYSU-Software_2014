...
/**
 * @class graphiti.shape.icon.Refresh

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Refresh();
 ...
 */
graphiti.shape.icon.Refresh = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Refresh",
