...
/**
 * @class graphiti.shape.icon.JQuery

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.JQuery();
 ...
 */
graphiti.shape.icon.JQuery = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.JQuery",
