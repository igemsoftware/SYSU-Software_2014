...
/**
 * @class graphiti.shape.icon.Chat

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Chat();
 ...
 */
graphiti.shape.icon.Chat = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Chat",
