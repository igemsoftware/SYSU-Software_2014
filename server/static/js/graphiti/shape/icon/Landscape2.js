...
/**
 * @class graphiti.shape.icon.Landscape2

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Landscape2();
 ...
 */
graphiti.shape.icon.Landscape2 = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Landscape2",
