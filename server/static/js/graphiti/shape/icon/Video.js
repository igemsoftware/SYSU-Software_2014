...
/**
 * @class graphiti.shape.icon.Video

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Video();
 ...
 */
graphiti.shape.icon.Video = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Video",
