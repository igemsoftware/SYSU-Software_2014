...
/**
 * @class graphiti.shape.icon.WheelChair

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.WheelChair();
 ...
 */
graphiti.shape.icon.WheelChair = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.WheelChair",
