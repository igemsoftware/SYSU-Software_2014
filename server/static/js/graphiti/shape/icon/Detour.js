...
/**
 * @class graphiti.shape.icon.Detour

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Detour();
 ...
 */
graphiti.shape.icon.Detour = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Detour",
