...
/**
 * @class graphiti.shape.icon.Cloud2

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Cloud2();
 ...
 */
graphiti.shape.icon.Cloud2 = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Cloud2",
