...
/**
 * @class graphiti.shape.icon.Aumade

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Aumade();
 ...
 */
graphiti.shape.icon.Aumade = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Aumade",
