...
/**
 * @class graphiti.shape.icon.Raphael

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Raphael();
 ...
 */
graphiti.shape.icon.Raphael = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Raphael",
