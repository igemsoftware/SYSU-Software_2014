...
/**
 * @class graphiti.shape.icon.Magic

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Magic();
 ...
 */
graphiti.shape.icon.Magic = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Magic",
