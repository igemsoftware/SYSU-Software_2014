...
/**
 * @class graphiti.shape.icon.Power

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Power();
 ...
 */
graphiti.shape.icon.Power = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Power",
