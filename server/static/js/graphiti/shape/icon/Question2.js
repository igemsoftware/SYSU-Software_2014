...
/**
 * @class graphiti.shape.icon.Question2

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Question2();
 ...
 */
graphiti.shape.icon.Question2 = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Question2",
