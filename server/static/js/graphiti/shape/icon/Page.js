...
/**
 * @class graphiti.shape.icon.Page

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Page();
 ...
 */
graphiti.shape.icon.Page = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Page",
