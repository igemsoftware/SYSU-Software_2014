...
/**
 * @class graphiti.shape.icon.Mail

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Mail();
 ...
 */
graphiti.shape.icon.Mail = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Mail",
