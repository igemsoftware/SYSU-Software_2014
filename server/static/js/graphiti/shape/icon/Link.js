...
/**
 * @class graphiti.shape.icon.Link

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Link();
 ...
 */
graphiti.shape.icon.Link = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Link",
