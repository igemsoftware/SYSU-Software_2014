...
/**
 * @class graphiti.shape.icon.CloudUp

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.CloudUp();
 ...
 */
graphiti.shape.icon.CloudUp = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.CloudUp",
