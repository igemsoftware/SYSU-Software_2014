...
/**
 * @class graphiti.shape.icon.Books

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Books();
 ...
 */
graphiti.shape.icon.Books = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Books",
