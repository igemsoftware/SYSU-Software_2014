...
/**
 * @class graphiti.shape.icon.Location

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Location();
 ...
 */
graphiti.shape.icon.Location = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Location",
