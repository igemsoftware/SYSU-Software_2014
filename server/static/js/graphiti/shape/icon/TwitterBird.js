...
/**
 * @class graphiti.shape.icon.TwitterBird

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.TwitterBird();
 ...
 */
graphiti.shape.icon.TwitterBird = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.TwitterBird",
