...
/**
 * @class graphiti.shape.icon.Page2

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Page2();
 ...
 */
graphiti.shape.icon.Page2 = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Page2",
