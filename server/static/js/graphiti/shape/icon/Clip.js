...
/**
 * @class graphiti.shape.icon.Clip

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Clip();
 ...
 */
graphiti.shape.icon.Clip = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Clip",
