...
/**
 * @class graphiti.shape.icon.Diagram

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Diagram();
 ...
 */
graphiti.shape.icon.Diagram = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Diagram",
