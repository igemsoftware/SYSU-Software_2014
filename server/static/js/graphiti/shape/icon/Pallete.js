...
/**
 * @class graphiti.shape.icon.Pallete

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Pallete();
 ...
 */
graphiti.shape.icon.Pallete = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Pallete",
