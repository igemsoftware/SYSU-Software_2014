...
/**
 * @class graphiti.shape.icon.Lamp_alt

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Lamp_alt();
 ...
 */
graphiti.shape.icon.Lamp_alt = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Lamp_alt",
