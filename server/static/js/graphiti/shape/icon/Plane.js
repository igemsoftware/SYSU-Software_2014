...
/**
 * @class graphiti.shape.icon.Plane

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Plane();
 ...
 */
graphiti.shape.icon.Plane = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Plane",
