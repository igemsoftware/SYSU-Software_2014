...
/**
 * @class graphiti.shape.icon.Picker

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Picker();
 ...
 */
graphiti.shape.icon.Picker = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Picker",
