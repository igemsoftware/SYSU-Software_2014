...
/**
 * @class graphiti.shape.icon.Star2Off

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.Star2Off();
 ...
 */
graphiti.shape.icon.Star2Off = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.Star2Off",
